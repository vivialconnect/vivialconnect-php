...
class Connection
{
    ...
    protected $options = [
        ...
        self::OPTION_RESPONSE_CLASS => 'VivialConnect\\Common\\Response',
        self::OPTION_UPDATE_METHOD => 'put',
        self::OPTION_UPDATE_DIFF => false,
        self::OPTION_MIDDLEWARE => [\VivialConnect\Filters\HmacAuth::class],
     ...
     * @param float $timing
     */
    private function addLog(Request $request, Response $response, $timing)
    {
        $this->log[] = [
            'request' => [
